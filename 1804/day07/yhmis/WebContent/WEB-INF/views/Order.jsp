...
<body>
	...
	<div>开单时间：<fmt:formatDate value="${order.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
	<div>结账时间：<fmt:formatDate value="${order.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
	...
	<hr class="line">
	<div>打印时间：<fmt:formatDate value="${order.printTime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
	<hr class="line">
